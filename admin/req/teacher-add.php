...
if (isset($_POST['fname']) &&
    ...
    if (empty($fname)) {
        ...
        $sql  = "INSERT INTO
                 teachers(username, password, class, fname, lname, subject, address, employee_number, date_of_birth, phone_number, qualification, gender, email_address)
                 VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = $conn->prepare($sql);
        $stmt->execute([$uname, $pass, $classes, $fname, $lname, $subject, $address, $employee_number, $date_of_birth, $phone_number, $qualification, $gender, $email_address]);
